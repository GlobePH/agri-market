<template>
  ...
  <layout>
    ...
    <section class="jumbotron text-center">
      <div class="container">
      <h1 class="jumbotron-heading">Selling > Edit</h1>
...
export default {
  ...
  methods: {
    ...
    submit() {
      api.update(this.form, this.$route.params.id, )
        .then(data => {
          ...
          if (data.error) {
            ...
            this.$router.push({
              name: 'sell-myitem', 
              params: {
                message: 'Item ID:' + data.id + ' ' + data.name  + ' successfully updated! ....',
              }
            });
